...
const MailFooter = () => {
  return (
    <div className="w-full bottom-0 lg:fixed items-center space-y-4 border-t border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 sm:sticky sm:flex sm:justify-between sm:space-y-0 mt-2">
