...
<div id="hs-bg-gray-on-hover-cards" className="  w-full h-full fixed top-10 left-0 z-[60] overflow-x-hidden overflow-y-auto">
  <div className="  mt-0  ease-out transition-all lg:max-w-4xl lg:w-full m-3 lg:mx-auto">
